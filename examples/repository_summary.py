#!/usr/bin/env python3
"""ORBIT Example — Repository Summary.

Usage:
    uv run examples/repository_summary.py [repository_path]
...
def main() -> None:
    ...
    # Bootstrap the ORBIT runtime (automatically configures default local LLM)
