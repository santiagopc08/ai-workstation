...
from orbit_knowledge import config
...
from orbit_knowledge.indexing.embeddings import get_embedding_provider, MockEmbeddingProvider
from orbit_knowledge.indexing.events import event_bus, DocumentCreated, DocumentUpdated, DocumentDeleted, IndexFinished
...
from orbit_knowledge.search import ranking, content, filename, semantic
...
class TestOrbitIndexerV2(unittest.TestCase):
    ...
    def test_simhash_fingerprints(self) -> None:
        ...
        from orbit_knowledge.fingerprints.simhash import SimHash, hamming_distance, are_near_duplicates
